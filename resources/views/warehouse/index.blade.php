...
@push('js')
    ...
    map.on('load', () => {
        ...
        .then(data => {
            ...
            const popup = new mapboxgl.Popup({ offset: 15 ,  maxWidth: '300px' }) // Tạo popup với khoảng cách từ marker
                .setHTML(`
                    <div class="custom-container">
                    <form class="form-group" action="{{ route('warehouses.destroy')}}" method="POST"> 
                        @csrf
    ...
    console.log('Giá trị tìm kiếm:', searchValue); // Kiểm tra giá trị

    $.ajax({
        url: `warehouses/geojson`,
        type: 'GET',
